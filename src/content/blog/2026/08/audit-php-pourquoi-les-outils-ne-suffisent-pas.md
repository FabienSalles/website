...
C'est cette lecture humaine que je propose dans mes audits. Pas un rapport de 500 lignes généré par un outil. Un diagnostic qui distingue le voulu de l'accidentel, qui priorise par impact business, qui assume les décisions qu'il propose.
